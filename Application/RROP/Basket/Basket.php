...
namespace SPHERE\Application\RROP\Basket;
...
class Basket implements IApplicationInterface
{
	public static function registerApplication()
	{
		Main::getDisplay()->addApplicationNavigation(
            new Link(new Link\Route(__NAMESPACE__), new Link\Name('Warenkorb'), new Link\Icon(new SearchIcon()))
        );
