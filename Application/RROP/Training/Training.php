...
namespace SPHERE\Application\RROP\Training;
...
class Training implements IApplicationInterface
{
	public static function registerApplication()
	{
		Main::getDisplay()->addApplicationNavigation(
            new Link(new Link\Route(__NAMESPACE__), new Link\Name('Schulungen'), new Link\Icon(new SearchIcon()))
        );
