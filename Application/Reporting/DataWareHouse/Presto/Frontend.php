...
use SPHERE\Application\Reporting\DataWareHouse\Presto\Converter\LoadImportPresto;
use SPHERE\Application\Reporting\DataWareHouse\Presto\Converter\ReadImportPresto;
...
class Frontend
{
    public function frontendImportPresto($Transfer = null)
    {
        $Stage = new Stage('Prestodaten importieren', '');
        ...
        if ($File) {
            ...
            if( (new LoadImportPresto( $File->getRealPath() ))->isValid() ) {
                Debugger::screenDump('Valid');

                new ReadImportPresto( $File->getRealPath() );
        ...
        $Stage->setContent(
            new Layout(array(
                new LayoutGroup(
                    ...
                    ), new Title('Prestodaten importieren')
                ),
//                new LayoutGroup(
//                    new LayoutRow(
//                        new LayoutColumn(
